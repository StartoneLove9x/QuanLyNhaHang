            ...
            <table cellpadding="0" cellspacing="0" border="1px" class="style2">
                ...
                <tr>
                    <td colspan="2" style="height: 30px" align="center">
                        <asp:Label ID="txtThongBao" runat="server" Text=""  ForeColor="Red"></asp:Label>
                    </td>
                </tr>
                <tr>
                    ...
                    <td align="left" style="line-height: 28px; padding-left: 3px;">
                        <asp:TextBox ID="txtUserName" runat="server" Width="96%" CssClass="style3"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                        ...
                        <asp:Label ID="Label1" runat="server" Text="Tài khoản admin/Mật khẩu 123456"></asp:Label>
                    </td>
                </tr>
            </table>
        </center>

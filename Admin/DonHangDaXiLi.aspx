<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" CodeFile="DonHangDaXiLi.aspx.cs" Inherits="Admin_DonHangDaXiLi" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="Server">
    ...
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="SOHOADON" DataSourceID="dataDonDatHang" CellPadding="4" ForeColor="#333333" GridLines="None" Width="888px" AllowPaging="True" >
        ...
        <Columns>
            ...
            <asp:HyperLinkField DataNavigateUrlFields="SOHOADON" DataNavigateUrlFormatString="DonHangDaXiLi.aspx?rq_SOHOADON={0}" DataTextField="SOHOADON" DataTextFormatString="Chi tiết" />
        </Columns>
    ...
    <asp:Button ID="cmdXuLi" runat="server" BackColor="#0066FF" Font-Bold="True" Font-Size="Large" ForeColor="White" Height="45px" OnClick="cmdXuLi_Click" Text="Chưa xử lí" Width="154px" />
    <br />
    <br />
